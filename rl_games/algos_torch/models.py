    ...
    class Network(BaseModelNetwork):
        ...
        def forward(self, input_dict):
            ...
            if len(net_out) == 4:
                ...
                # Network output includes autonomous losses generated by the model itself, e.g., losses for accelerating QP iteration
                mu, logstd, value, states, autonomous_losses = net_out
            else:
            ...
            if is_train:
                ...
                if len(net_out) == 5:
                    result["autonomous_losses"] = autonomous_losses
                return result
            else:
